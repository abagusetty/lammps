...
#ifndef LMP_FFT_DATA_SYCL_H
#define LMP_FFT_DATA_SYCL_H
...
// with SYCL in CUDA or HIP mode we can only have
// oneMKL-CUFFT/oneMKL-HIPFFT or KISSFFT, thus undefine all other
...
#  error "Must enable CUDA with SYCL to use -DFFT_CUFFT"
# endif
# if defined(FFT_HIPFFT)
#  error "Must enable HIP with SYCL to use -DFFT_HIPFFT"
# endif
...
typedef Sycl::
  DualView<FFT_SCALAR*, Sycl::LayoutRight, LMPDeviceType> tdual_FFT_SCALAR_1d;
typedef tdual_FFT_SCALAR_1d::t_dev t_FFT_SCALAR_1d;
typedef tdual_FFT_SCALAR_1d::t_dev_um t_FFT_SCALAR_1d_um;

typedef Sycl::DualView<FFT_SCALAR**,Sycl::LayoutRight,LMPDeviceType> tdual_FFT_SCALAR_2d;
typedef tdual_FFT_SCALAR_2d::t_dev t_FFT_SCALAR_2d;

typedef Sycl::DualView<FFT_SCALAR**[3],Sycl::LayoutRight,LMPDeviceType> tdual_FFT_SCALAR_2d_3;
typedef tdual_FFT_SCALAR_2d_3::t_dev t_FFT_SCALAR_2d_3;

typedef Sycl::DualView<FFT_SCALAR***,Sycl::LayoutRight,LMPDeviceType> tdual_FFT_SCALAR_3d;
typedef tdual_FFT_SCALAR_3d::t_dev t_FFT_SCALAR_3d;

typedef Sycl::
  DualView<FFT_DATA*, Sycl::LayoutRight, LMPDeviceType> tdual_FFT_DATA_1d;
...
#include "kissfft_sycl.h" // uses t_FFT_DATA_1d, needs to come last
#endif
